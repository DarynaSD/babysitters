...
import { getDatabase, ref, get, query, orderByValue, limitToFirst, startAfter } from "firebase/database";
...
export const fetchAllNannies = createAsyncThunk(
  ...
  async (filter, page, thunkAPI) => {
    ...
    try {
      ...
      const dbRef = query(ref(db, "nannies"), orderByValue('rating'), startAfter(4), limitToFirst(20));
